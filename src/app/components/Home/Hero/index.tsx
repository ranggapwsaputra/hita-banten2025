          ...
          <div className='col-span-6 flex flex-col gap-8'>
            <div className='flex gap-2 mx-auto lg:mx-0'>
              ...
              <p className='text-success text-sm font-semibold text-center lg:text-start tracking-widest uppercase'>
                Hotel Information Technology Association Banten region
              </p>
            </div>
            <h1 className='text-midnight_text md:text-start text-center font-semibold leading-tight capitalize'>
            ...
            <p className='text-black/70 text-lg lg:text-start text-center max-w-xl capitalize'>
              Join the IT Hotel Community for a digital journey in redefining guest experiences. ✨🧑‍💻
            </p>
